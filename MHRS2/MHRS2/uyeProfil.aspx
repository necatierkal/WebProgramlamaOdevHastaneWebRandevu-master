...
<!-- menu-->
	<div id="menu">
		...
		<div class="kutu mavi">
			<a href="uyeProfil.aspx"><i class="fa fa-pencil-square-o"></i>
			Hesap Bilgileri</a>
		</div>
		...
		<div class="col-md-6 solSecimAlani">
			<table class="table table-hover">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>  
                        <asp:Button ID="btnGuncelle" runat="server" CssClass="btn btn-success" OnClick="btnGuncelle_Click" Text="Güncelle" />
                        <br /><br /><br />
